...
function sumOfMultiples() {
    ...
    //    return a + b;
    //}
    //Rows 87-93 are the second solution that I created for this problem. Its memory usage does not increase as the range max variable increases.  However, this solution is inefficient for large numbers.
//        var sumMultiples = 0;
//    
//        for (i = 1; i < target; i++) {
//            if (i % num1 == 0 || i % num2 == 0) {
